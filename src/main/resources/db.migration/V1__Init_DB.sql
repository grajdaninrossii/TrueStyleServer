...
alter table likes_stuff add constraint FKjb61wqqg38fdhuksv8rerdta8 foreign key (stuff_id) references stuff;
...
alter table stuff add constraint FK3flocpy21qm9orl3d7fbaywqs foreign key (gender_id) references gender;
...
alter table wardrobe add constraint FKog09vtv2yxg2jyisxhlai4rub foreign key (stuff_id) references stuff;
